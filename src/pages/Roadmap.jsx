...
import imgRover5 from '/assets/img/prototypes/RoverPrototype5.png';

const Roadmap = () => {
  const { t } = useTranslation('translation', { keyPrefix: 'roadmap' });

  const milestones = t('milestones', { returnObjects: true });
  const prototypeIndices = [1, 2, 4, 5, 6];
  const [currIndex, setCurrIndex] = useState(6);
      ...
      <div id="roadmap" className='w-full py-8'>
        <div className='max-w-[1240px] mx-auto px-4'>
          ...
          <div className='grid md:grid-cols-2 md:gap-10'>
            ...
            <div className={currIndex === 6 ? 'visible' : 'hidden'}>
              <RoverDetails header={t('roverProto5.header')} img={imgRover5} characteristics={[
              ]} />
            </div>
