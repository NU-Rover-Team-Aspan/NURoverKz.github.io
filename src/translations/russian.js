const ru = {
  ...
  team: {
    ...
    infoAlmat: {
      ...
      position: 'Команда Программирования',
    ...
    infoTomiris: {
      ...
      achievements: ['Ассистент по исследованию в лаборатории биоматериалов и регенеративной инженерии',
        "Топ 1 CGPA в своем потоке Химической инженерии-2025 с 3 наградами Dean's list"]
    },
    infoMuslim: {
    ...
    infoSymbat: {
      ...
      achievements: ['Автор инстаграм-видео и постов, ориентированных на сообщество НУ, с более чем 14 тысячами просмотров и тысячами лайков',
       'SMM-менеджер, фотограф и видеооператор коммерческой компании более 3 лет']
    },
    infoDana: {
      fullname: 'Құрманғали Дана',
      position: 'Команда Маркетинга/Брендинга',
      achievements: ['Участница «Наноспутниковой образовательной программы для девочек Unisat» (UNEPG), успешно запустившей наноспутник в стратосферу',
